				...
				{	
						...
						if (util.copyFilesToTestServer(mid, cid, testDataFile, userName, copiedFiles, currencyID,isoCode))
						{
							...
							if("Yes".equalsIgnoreCase(cfnlib.XpathMap.get("NFD"))) {
								...
								if(imageLibrary.isImageAppears("NFDButton"))
								{
									...
									sanityReport.detailsAppendFolder("Verify Continue button is visible ", "Continue buttion is visible", "Continue button is visible", "PASS",currencyName);										
								...
								else
								{
									...
									sanityReport.detailsAppendFolder("Verify Continue button is visible ", "Continue buttion is visible", "Continue button is not visible", "FAIL",currencyName);
								}
							}		
							...
							{								
								...
								if(imageLibrary.isImageAppears("BetMax"))
								{
									...
									sanityReport.detailsAppendFolder("Bet menu", "Bet menu", "Bet menu is opened", "PASS",currencyName);
									...
									if(cfnlib.XpathMap.get("CoinSizeSliderPresent").equalsIgnoreCase("Yes"))
									{
										...
										{
											sanityReport.detailsAppendFolder("Coin Size Slider", "Coin Size Slider is should work", "Coin Size Slider is working", "PASS",currencyName);										
										}
										else
										{
											sanityReport.detailsAppendFolder("Coin Size Slider", "Coin Size Slider should work", "Coin Size Slider is not working", "FAIL",currencyName);
										}
									}
									...
									if(cfnlib.XpathMap.get("CoinsPerLineSliderPresent").equalsIgnoreCase("Yes"))
									{
										...
										if(bet1.equalsIgnoreCase(bet2) != true)
										{									
											sanityReport.detailsAppendFolder("Coins per Line Slider", "Coins Per Line Slider should work", "Coins Per Line Slider is working", "PASS",currencyName);
										}
										else
										{
											sanityReport.detailsAppendFolder("Coins per Line Slider", "Coins Per Line Slider should work", "Coins Per Line Slider is not working", "FAIL",currencyName);
										}							
									}
									if(cfnlib.XpathMap.get("LinesSliderPresent").equalsIgnoreCase("Yes"))
									{
										...
										if(bet1.equalsIgnoreCase(bet2) != true)
										{
											sanityReport.detailsAppendFolder( "Line Slider", "Line Slider should work", "Line Slider is not working", "PASS",currencyName);
										}
										else
										{
											sanityReport.detailsAppendFolder("Line Slider", "Line Slider should work", "Line Slider is not working", "FAIL",currencyName);
										}									
									}
									...
									if(imageLibrary.isImageAppears("Spin"))
									{									
										sanityReport.detailsAppendFolder("Max Bet", "Click on Max Button", "Base Scene is visible", "PASS",currencyName );
									}
									else
									{
										System.out.println("Clicked on Max Bet not working");log.debug("Clicked on Max Bet not working");
										sanityReport.detailsAppendFolder("Max Bet", "Click on Max Button", "Base Scene is visible not visible", "FAIL",currencyName );
									}
									Thread.sleep(2000);
								}
							} // Bet Validation end
							...
							sanityReport. detailsAppend("Following is the Win booster verification test case" ,"Verify Win booster", "", "");
							...
							if(cfnlib.XpathMap.get("QuickSpinonBaseGame").equalsIgnoreCase("Yes"))
							{
								if(imageLibrary.isImageAppears("QuickSpinOff"))
								{
									...
									{
										sanityReport.detailsAppendFolder("Win booster Button ", "Win booster Button should be clicked", "Win booster button is clicked", "PASS",currencyName);
										
										
										//sanityReport.detailsAppendFolder("Quick spin Buttom ", "Quick Spin button should be clicked", "Quick Spin button is clicked", "PASS",currencyName);
									}
									else{
										//sanityReport.detailsAppendFolder("Quick spin Buttom ", "Quick Spin button should be clicked", "unable to click on quick spin", "FAIL",currencyName);
										sanityReport.detailsAppendFolder("Win booster Button ", "Win booster Button should be clicked", "Win booster button is not clicked", "FAIL",currencyName);
										
									}								
								}
								else {
									sanityReport.detailsAppendFolder("Quick spin Buttom ", "Quick Spin button should be available", "quick spin button is not visible", "FAIL",currencyName);				
								}
							}
					...
					//click on menu
						...
						if(imageLibrary.isImageAppears("Menu"))
						{
							...
							sanityReport.detailsAppendFolder("Menu Open ", "Menu should open", "Menu is Opened", "PASS",currencyName);
							if(imageLibrary.isImageAppears("Paytable"))
							{
								sanityReport.detailsAppendFolder("PayTable Button ", "PayTable should visible", "PayTable is visible", "PASS",currencyName);
								//click on PayTable
								imageLibrary.click("Paytable");
								Thread.sleep(2000);																
								if(cfnlib.elementVisible_Xpath(cfnlib.XpathMap.get("PaytableClose")))
								{
									sanityReport.detailsAppendFolder("PayTable ", "PayTable should opened", "PayTable is opened", "PASS",currencyName);
									Thread.sleep(2000);
									boolean scrollPaytable = cfnlib.paytableScroll(sanityReport, currencyName);
									if (scrollPaytable) {										
										sanityReport.detailsAppendFolder("PayTable ", "PayTable Scroll ", "PayTable Scroll", "Pass",currencyName);
									
									} else {
									
										sanityReport.detailsAppendFolder("PayTable ", "PayTable Scroll ", "PayTable Scroll", "FAIL", currencyName);
									}
									...
									if(imageLibrary.isImageAppears("Spin"))
									{
										...
										sanityReport.detailsAppendFolder("Verify Paytable Closed", "Paytable should be Closed", "Base Scene is visible after paytable closed", "PASS", currencyName );
									}
									else
									{
										System.out.println("Paytable is not Closed");log.debug("Paytable is not Closed");
										sanityReport.detailsAppendFolder("Verify Paytable Closed", "Paytable should be Closed", "Paytable is not closed", "FAIL", currencyName );
									}										
								}
								else
								{
									sanityReport.detailsAppendFolder("PayTable ", "PayTable should opened", "PayTable is not opened", "FAIL",currencyName);
								}									
							}
							else
							{
								sanityReport.detailsAppendFolder("PayTable Button", "PayTable button should be visible", "PayTable button is not visible", "FAIL",currencyName);
							}
						}								
						else
						{
							sanityReport.detailsAppendFolder("Menu Open ", "Menu should be opened", "Menu is not Opened", "FAIL",currencyName);
						}
					//Setting Toggle
					try {
					...
					if(imageLibrary.isImageAppears("Menu"))
					{
						...
						{							
							...
							Thread.sleep(2000);														
							sanityReport.detailsAppendFolder("Setting open ", "Settings should be open", "Settings is open", "PASS",currencyName);													
								//quick spin toggle
								/*if(cfnlib.isElementVisible("isSettingsTurboVisible"))
								{
									...
									sanityReport.detailsAppendFolder("Turbo toggle in settings ", "Turbo toggle in settings should work", "Turbo toggle in settings is working", "PASS",currencyName);
								}
								...
								{									
									...
									Thread.sleep(2000);
									//take screenshot of sound toggle working
									sanityReport.detailsAppendFolder("Voice over toggle in settings ", "Voice over toggle in settings should work", "Voice over toggle in settings is working", "PASS",currencyName);							
								}
								...
								{									
									...
									Thread.sleep(2000);
									//take screenshot of sound toggle working
									sanityReport.detailsAppendFolder("Sound toggle in settings ", "Sound toggle in settings should work", "Sound toggle in settings is working", "PASS",currencyName);								
								}					*/		
								//close settings
								...
								if("Yes".equalsIgnoreCase(cfnlib.XpathMap.get("settingsUnderMenu"))) {
									...
									Thread.sleep(1000);
										...
										cfnlib.ClickByCoordinates("return " + cfnlib.XpathMap.get("exitSettingsx"), "return " + cfnlib.XpathMap.get("exitSettingsy"));							
								}
								Thread.sleep(2000);								
								/*if(imageLibrary.isImageAppears("Spin"))
								{
									sanityReport.detailsAppendFolder("Base Scene after Settings closed ", "Base Scene after Settings closed", "We are on Base Scene after Settings closed", "PASS",currencyName);	
								}
								else
								{
									sanityReport.detailsAppendFolder("Base Scene after Settings closed ", "Base Scene after Settings closed", "We are not on Base Scene after Settings closed", "FAIL",currencyName);
								}	*/					
							}
						}	
					}catch (Exception e) {
					...
					{						
						sanityReport.detailsAppendFolder("Help Icon ", "Help Icon", "Help Icon is visible", "PASS",currencyName);
						//click on help
						Thread.sleep(2000);
						cfnlib.func_Click(cfnlib.XpathMap.get("HelpIcon"));
						Thread.sleep(3000);	
						sanityReport.detailsAppendFolder("Verify if help navigation ", "Help should navigated", "Help is navigated", "PASS",currencyName);
						...
						if((cfnlib.XpathMap.get("SameWindow")).equalsIgnoreCase("No"))
						{
							...
							cfnlib.navigate_back(sanityReport,currencyName);
							Thread.sleep(1000);
						}
						...
						if(imageLibrary.isImageAppears("Spin"))
						{
							...
							sanityReport.detailsAppendFolder("Back from help", "Back from help", "On BaseScene, Back from help", "PASS",currencyName);
						}
						else
						{
							
							sanityReport.detailsAppendFolder("Back from help", "Back from help", "Not on BaseScene, Back from help", "FAIL",currencyName);
						}	
					
					}
					else
					{
						sanityReport.detailsAppendFolder("Help icon", "Help icon", "Help icon is not visible", "FAIL",currencyName);
					}
					...
					if(imageLibrary.isImageAppears("Autoplay")) 
					{
						...
						{
							sanityReport.detailsAppendFolder("Auto play menu", "Auto play menu", "Auto play menu is opened", "PASS",currencyName);
							...
							try
							{
								if(cfnlib.XpathMap.get("SpinSliderPresent").equalsIgnoreCase("Yes"))
								{
									...
									{
										sanityReport.detailsAppendFolder("Autoplay", "Spin slider", "Spin slider is working", "PASS",currencyName);
									}
									else
									{
										sanityReport.detailsAppendFolder("Autoplay", "Spin slider", "Spin slider is not working", "FAIL",currencyName);
									}
								}
							}catch (Exception e) {
								log.error(e.getMessage(),e);
							...
							try
							{
								if(cfnlib.XpathMap.get("TotalBetSliderPresent").equalsIgnoreCase("Yes"))
								{
									...
									if(s1.equalsIgnoreCase(s2) != true)
									{
										sanityReport.detailsAppendFolder("Autoplay", "Total bet slider", "Total bet slider is working", "PASS",currencyName);
									}
									else
									{
										sanityReport.detailsAppendFolder("Autoplay", "Total bet slider", "Total bet slider is not working", "FAIL",currencyName);	}
								}
							}catch (Exception e) {
								log.error(e.getMessage(),e);
								cfnlib.evalException(e);
							...
							try
							{
								if(cfnlib.XpathMap.get("WinLimitSliderPresent").equalsIgnoreCase("Yes"))
								{
									...
									if(s1.equalsIgnoreCase(s2) != true)
									{
										sanityReport.detailsAppendFolder("Autoplay", "Win Limit", "Win Limit is working", "PASS",currencyName);
									}
									else
									{
										sanityReport.detailsAppendFolder("Autoplay", "Win Limit", "Win Limit is not working", "FAIL",currencyName);
									}
								}
							}catch (Exception e) {
								log.error(e.getMessage(),e);
							...
							try
							{
								if(cfnlib.XpathMap.get("LossLimitSliderPresent").equalsIgnoreCase("Yes"))
								{
									...
									if(s1.equalsIgnoreCase(s2) != true)
									{
										sanityReport.detailsAppendFolder("Autoplay", "Loss Limit", "Loss Limit slider is working", "PASS",currencyName);
									}
									else
									{
										sanityReport.detailsAppendFolder("Autoplay", "Loss Limit", "Loss Limit slider is not working", "FAIL",currencyName);
									}
								}
							}
							catch (Exception e) {
							...
							try
							{
								if(imageLibrary.isImageAppears("StartAutoplay"))
								{
									...
									{
										sanityReport.detailsAppendFolder("Autoplay", "Autoplay should work", "Autoplay is working", "PASS",currencyName);
									}
									else
									{
										sanityReport.detailsAppendFolder("Autoplay", "Autoplay should work", "Autoplay is not working", "FAIL",currencyName);
									}
								}
								else 
								{
									sanityReport.detailsAppendFolder("Autoplay", "Start Autoplay BTN visibility", "Start Autoplay BTN is not Visible", "FAIL",currencyName);
								}	
							}
							catch(Exception e)
							{
						...
						{
							sanityReport.detailsAppendFolder("Auto play menu", "Auto play menu", "Auto play menu is not opened", "FAIL",currencyName);
						}	

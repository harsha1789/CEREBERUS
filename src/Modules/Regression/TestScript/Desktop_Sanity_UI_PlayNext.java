...
import org.python.util.PythonInterpreter; //Added to integrate AI model 
/**
...
public class Desktop_Sanity_UI_PlayNext {
		...
		public void script() throws Exception
		{
			...
			try {
			    // Your code that causes the exception
			String command ="'D:/ImageComparision/addnumbers.py\\n'";
			System.out.println("IN Python execution ");
			PythonInterpreter pythonInterpreter =new PythonInterpreter();//Added to integrate AI model 
			pythonInterpreter.exec(command);
			System.out.println("IN Python file execution  ");
		    ...
		    // Handle the cause appropriately
		}
			...
			try
			{
				...
				{	
					...
					{						
						...
						Thread.sleep(3000);	
						sanityReport.detailsAppendFolder("Verify if help navigation ", "Help should navigated", "Help is navigated", "PASS",languageCurrency);
						...
						if((cfnlib.XpathMap.get("SameWindow")).equalsIgnoreCase("No"))
						{
							...
							cfnlib.checkpagenavigation(sanityReport,languageCurrency,gameurl);
							Thread.sleep(1000);
						}

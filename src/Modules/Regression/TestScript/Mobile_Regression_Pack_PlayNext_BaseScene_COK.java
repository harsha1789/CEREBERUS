...
public class Mobile_Regression_Pack_PlayNext_BaseScene_COK {
	public ScriptParameters scriptParameters;
	Logger log = Logger.getLogger(Mobile_Regression_Pack_PlayNext_BaseScene_COK.class.getName());
					...
					if (util.migrateUser(userName))
					{
						...
						if (util.updateUserBalance(userName, balance)) {
							...
							webdriver.navigate().to(launchURl);
								...
								lvcReport.detailsAppendFolder("Verify Game launchaed ", "Game should be launched", "Game is launched","PASS",isoCode);
								...
								if (imageLibrary.isImageAppears("Menu")) {
									...
									lvcReport.detailsAppendFolder("Verify if able to click on Menu",
									...
									if (imageLibrary.isImageAppears("Autoplay")) 
									{
										...
										Thread.sleep(3000);
										lvcReport.detailsAppendFolder("Verify able to click on Autoplay",
										...
										if (imageLibrary.isImageAppears("StartAutoplay")) 
										{
											...
											lvcReport.detailsAppendFolder("Verify able to click StartAutoplay",
													"Should be able to click on StartAutoplay",
													"Able to click on StartAutoplay", "PASS",languageCurrency);
										} else {
											lvcReport.detailsAppendFolder("Verify if able to click on StartAutoplay",
													"Should be able to click on StartAutoplay",
										...
										if (imageLibrary.isImageAppears("AutoplayStop")) {
											...
											lvcReport.detailsAppendFolder("Verify able to click on AutoplayStop",
													"Should be able to click on Autoplay button",
													"Able to click on AutoplayStop", "PASS",languageCurrency);
										} else {
											lvcReport.detailsAppendFolder("Verify if able to click on AutoplayStop",
													"Should be able to click on AutoplayStop",
													"Not able to click on AutoplayStop", "Fail",languageCurrency);
										}

									} else {
										lvcReport.detailsAppendFolder("Verify if able to click on Autoplay",
									...
									if (imageLibrary.isImageAppears("Menu")) {
										...
										if (imageLibrary.isImageAppears("BetMenu")) {
											...
											lvcReport.detailsAppendFolder("Verify able to click on BetMenu",
													...
													"Able to click on BetMenu button", "PASS",languageCurrency);
										} else {
											lvcReport.detailsAppendFolder("Verify if able to click on BetMenu",
													"Should be able to click on BetMenu",
													"Not able to click on BetMenu", "Fail",languageCurrency);
										}
										...
										/*if (imageLibrary.isImageAppears("MaxBet")) 
										{
											...
											Thread.sleep(3000);
											//lvcReport.detailsAppendFolder("Verify able to click on MaxBet","Should be able to click on MaxBet","Able to click on MaxBet", "PASS",languageCurrency);
											lvcReport.detailsAppendFolder("Verify able to click on MaxBet","Should be able to click on MaxBet","able to click on MaxBet", "Pass",languageCurrency);
										} else {
											lvcReport.detailsAppendFolder("Verify if able to click on MaxBet",
										...
										if (imageLibrary.isImageAppears("MenuBack")) {
											...
											lvcReport.detailsAppendFolder("Verify able to click on MenuBack",
													"Should be able to click on MenuBack button",
													"Able to click on MenuBack button", "PASS", languageCurrency);
										} else {
											lvcReport.detailsAppendFolder("Verify if able to click on MenuBack",
										...
										if (imageLibrary.isImageAppears("Menu1")) {
											...
											Thread.sleep(3000);
											lvcReport.detailsAppendFolder("Verify able to click on Menu",
													"Should be able to click on Menu button", "Able to click on Menu button", "PASS",languageCurrency);
										} else {
											lvcReport.detailsAppendFolder("Verify if able to click on Menu", "Should be able to click on Menu",
													"Not able to click on Menu", "Fail",languageCurrency);
										}
										...
										if (imageLibrary.isImageAppears("MenuBack")) {
											...
											lvcReport.detailsAppendFolder("Verify if able to click on MenuBack",
													"Should be able to click on MenuBack", "Not able to click on MenuBack", "Fail",languageCurrency);
										}
										...
										try {
											...
											if (imageLibrary.isImageAppears("Spin")) {
												...
												lvcReport.detailsAppendFolder("Verify if able to click on Spin",
														"Should be able to click on Spin", "Not able to click on Spin", "Fail",languageCurrency);
											}
										} catch (Exception e) {
											log.error(e.getMessage(), e);
										}
										...
										try {
											...
											if (imageLibrary.isImageAppears("FreeSpinEntry")) 
											{
												...
												lvcReport.detailsAppendFolder("Verify if able to click on Freespin Entry",
														"Should be able to click on  Freespin Entry", "Not able to click on Freespin Entry", "Fail",languageCurrency);
											}
											...
											if (imageLibrary.isImageAppears("FSLetsGo")) 
											{
												...
												lvcReport.detailsAppendFolder("Verify if able to click on FreeSpin LetsGo",
														"Should be able to click on FreeSpin LetsGo", "Not able to click on FreeSpin LetsGo", "Fail",languageCurrency);
											}
											...
											if (imageLibrary.isImageAppears("FreeSpinSum")) {
												...
												lvcReport.detailsAppendFolder("Verify if able to click on  FreeSpin Summary ",
														"Should be able to click on  FreeSpin Summary", "Not able to click on  FreeSpin Summary", "Fail",languageCurrency);
											}

...
public class Desktop_Regression_GameTracking {
	Logger log = Logger.getLogger(Desktop_Regression_GameTracking.class.getName());
	...
	public void script() throws Exception {
		...
		int mintWarnings=0;
		int mintStepNo=0;
		Desktop_HTML_Report trackingReport = new Desktop_HTML_Report(webdriver, Browsername, filePath, startTime,
		...
		CFNLibrary_Desktop cfnlib=desktopFunctionLibraryFactory.getFunctionLibrary(framework, webdriver, proxy, trackingReport, gameName);
		...
		try {
			if (webdriver != null) {
				...
				log.debug("Started");
				userName="player723";
				//String url = "https://mobilewebserver9-zensardev2.installprogram.eu/MobileWebGames/game/mgs/9_15_0_7290?moduleID=10145&clientID=50300&gameName=immortalRomanceDesktop&gameTitle=Immortal%20Romance&LanguageCode=anil&clientTypeID=40&casinoID=5007&lobbyName=IslandParadise&loginType=InterimUPE&lobbyURL=https://mobilewebserver9-ZensarDev2.installprogram.eu/Lobby/en/IslandParadise/Games/3ReelSlots&xmanEndPoints=https://mobilewebserver9-ZensarDev2.installprogram.eu/XMan/x.x&bankingURL=https://mobilewebserver9-ZensarDev2.installprogram.eu/Lobby/en/IslandParadise/Banking&routerEndPoints=&isPracticePlay=false&username=player865&password=test&host=Desktop&apicommsenabled=false&launchtoken=&version=";
				...
				//String url ="https://mobilewebserver9-zensarqa2.installprogram.eu/MobileWebGames/game/mgs/9_18_2_7574?moduleID=10206&clientID=50300&gameName=breakAwayDesktop&gameTitle=Break%20Away&LanguageCode=en&clientTypeID=40&casinoID=5007&lobbyName=IslandParadise&loginType=InterimUPE&lobbyURL=https://mobilewebserver9-ZensarQA2.installprogram.eu/Lobby/en/IslandParadise/Games/3ReelSlots&xmanEndPoints=https://mobilewebserver9-ZensarQA2.installprogram.eu/XMan/x.x&bankingURL=https://mobilewebserver9-ZensarQA2.installprogram.eu/Lobby/en/IslandParadise/Banking&routerEndPoints=&isPracticePlay=false&username=player786&password=test&host=Desktop&apicommsenabled=false&launchtoken=&version=";
				//String url ="https://mobilewebserver9-zensarqa.installprogram.eu/MobileWebGames/game/mgs/9_18_2_7574?moduleID=10206&clientID=50300&gameName=breakAwayDesktop&gameTitle=Break%20Away&LanguageCode=en&clientTypeID=40&casinoID=5007&lobbyName=IslandParadise&loginType=InterimUPE&lobbyURL=https://mobilewebserver9-ZensarQA.installprogram.eu/Lobby/en/IslandParadise/Games/3ReelSlots&xmanEndPoints=https://mobilewebserver9-ZensarQA.installprogram.eu/XMan/x.x&bankingURL=https://mobilewebserver9-ZensarQA.installprogram.eu/Lobby/en/IslandParadise/Banking&routerEndPoints=&isPracticePlay=false&username=player743&password=test&host=Desktop&apicommsenabled=false&launchtoken=&version=";
				webdriver.get(url);
	...
	public void validateEventType( int eventType,Har nhar, Desktop_HTML_Report trackingReport,String message){
	...
	public void validateSpinSpeed(int eventType,Har nhar, Desktop_HTML_Report trackingReport,String message,int spinSpeed){
...
public void validateSpinMethod( int eventType,Har nhar, Desktop_HTML_Report trackingReport,String message,int spinMethod){
...
public void validateLoadType( int eventType,Har nhar, Desktop_HTML_Report trackingReport,String message,int loadType){
...
public void validateBackGroundSounds( int eventType,Har nhar, Desktop_HTML_Report trackingReport,String message,int soundType){
	...
	public void validateEventTypeDuration( int eventType,Har nhar, Desktop_HTML_Report trackingReport,String message){

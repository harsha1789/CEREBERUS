...
public class CFNLibrary_Desktop_PlayNext extends CFNLibrary_Desktop {
	...
	public boolean verifyGridPayouts(Desktop_HTML_Report report, String regExp,String CurrencyName) {		
	   ...
	   public boolean waitForElement(String hook)
	        ...
	        try{
	            ...
	            while(true)
	            {
	                ...
	                else
	                {
	                    ...
	                    if(((currentime-startTime)/500)> 30)
	                    {
	                    log.info("No value present after 30 seconds= "+ele);
	                    System.out.println("No value present after 60 seconds= "+ele);
	                    result=false;
	                    break;            
	                    }
	               }
		 ...
		 */
		public String freeGameEntryInfo(Desktop_HTML_Report report,String currencyName,ImageLibrary imageLibrary, String fgInfotxt ) throws InterruptedException  
		{
...
*/				
			...
			/*	**
	           ...
	           public void checkpagenavigation(Desktop_HTML_Report report, String languageCurrency,String gameurl) {
	       		try {
	       					...
	       					if (mainwindow.equalsIgnoreCase(ChildWindow)) {
	       						...
	       						if (!url.equalsIgnoreCase(gameurl)) {
	       							...
	       							report.detailsAppendFolder("verify the Navigation screen shot", " Navigation page screen shot",
	       									"Navigation page screenshot ", "PASS",languageCurrency);
